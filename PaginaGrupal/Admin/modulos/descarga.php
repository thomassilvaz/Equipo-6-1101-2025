<!-- Contenedor principal de la sección de descargas -->
<div class="descargas-container" style="max-width: 1200px; margin: 0 auto; padding: 20px; font-family: 'Silkscreen', cursive; background: #f0f8ff; border: var(--pixel-border); box-shadow: var(--pixel-shadow); position: relative;">
    ...
    <!-- Encabezado de la sección de descarga -->
    <div class="descargas-header" style="text-align: center; margin-bottom: 40px;">
        ...
        <!-- Separador decorativo con ícono de descarga -->
    ...
    <!-- Sección de pasos de instalación -->
    ...
    <!-- Sección de descarga específica para Windows -->
    <div class="versiones-section" style="margin-bottom: 40px; padding: 20px; border: var(--pixel-border); background-color: white; box-shadow: var(--pixel-shadow); position: relative;">
        ...
        <!-- Tarjeta con información de la versión -->
        <div class="versiones-grid" style="display: flex; justify-content: center;">
            <div class="version-card glitch" style="background: white; border: var(--pixel-border); padding: 25px; text-align: center; box-shadow: var(--pixel-shadow); transition: all 0.3s ease; max-width: 400px; width: 100%;">
                ...
                <!-- Botón de descarga (debes reemplazar el # por el enlace real al .exe) -->
...
/* Cuadraditos decorativos tipo esquina pixelada */
.pixel-corner {
    position: absolute;
    width: 16px;
    height: 16px;
...
/* Muestra la respuesta del FAQ al abrir */
...
@media (max-width: 480px) {
    .titulo-principal { font-size: 1.5rem !important; }
    .subtitulo { font-size: 1rem !important; }
    .version-card { padding: 15px !important; }
    .section-title { font-size: 1.2rem !important; }
}
</style>

<script>
// Este script controla el comportamiento de las preguntas frecuentes (FAQ)
// Cuando se hace clic en una pregunta, alterna su estado activo para mostrar/ocultar la respuesta
